...
rclone copy --tpslimit 10 --fast-list -P --drive-shared-with-me New\ Remote:CSU-con-gen-2020/pre-indexed-chinook-genome  pre-indexed-chinook-genome
...
rclone copy --tpslimit 10 --fast-list -P --drive-shared-with-me New\ Remote:CSU-con-gen-2020/fastqs-chr32-160-chinook-8-lanes  fastqs-chr32-160-chinook-8-lanes
...
ln -s /hb/scratch/ccolumbu/chinook-play/chinook-genome-idx genome
...
# Here is what I did (making a symbolic link)
ln -s  /hb/scratch/ccolumbu/fastqs-chr32-160-chinook-8-lanes fastqs
